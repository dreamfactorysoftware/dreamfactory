...
return [
    ...
    'confirm_reset_url'            => url(env('CONFIRM_RESET_URL', '/dreamfactory/dist/#/reset-password')),
    'confirm_invite_url'           => url(env('CONFIRM_INVITE_URL', '/dreamfactory/dist/#/user-invite')),
    'cors'                         => [
        'defaults' => [
